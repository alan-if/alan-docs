...
In this beginner's guide we will do it this way (note than whenever new code is displayed in this guide it will be in [red]#RED#):

// @ALAN: CHECK CODE & ENABLE HIGHLIGHTING
[subs="quotes"]
----
 [red]#-----------------------------------------------
 --             \*\** TV TIME! \***
...
[source,alan,role=lib,subs=none]
--------------------------------------------------------------------------------
include::./_adoc/inc_nowhere.utf8_alan[]
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
include::./_adoc/inc_std.utf8_alan[lines=1..50]
#import 'nowhere.i'.#
include::./_adoc/inc_std.utf8_alan[lines=52..-1]
--------------------------------------------------------------------------------
...
The interpreter will then give the message "I don't know the word television." To preclude that, we can give the TV a
NAME.
...
LOCATION.
If there are OBJECTS in the LOCATION, they will be described
to the player.
In the case of the TV, and any other OBJECTS that we
...
The "plasma.jpg" is included in the download of this tutorial.
...
The changes are indicated in [red]#RED#.
Any time we make changes to the library, it is a good idea to add notes (indicated in this tutorial with [red]#{3ast}#) so the changes can be easily identified.
...
OMIT all the rest.
We won't need "plug near", "plug behind", "plug on"
or "plug under".
...
[source,alan]
--------------------------------------------------------------------------------
include::./_adoc/inc_tvtime.utf8_alan[]
--------------------------------------------------------------------------------
