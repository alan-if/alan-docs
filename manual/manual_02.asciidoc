...
// @FIXE @thoni56:
//     The sentence "to have the same view that the Alan language has on..."
//     needs rephrasing and polishing! too long, entangled, and a bit strecthed too.
//
//     PROPOSAL:
//        As an author you'll need to learn to view a work of interactive
//        fiction through the "`eyes of Alan language`", so to speak.
