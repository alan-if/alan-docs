...
// @NOTE: "The `Else` clause is optional", so is the 'ElseIf' clause. Should add
//        that too, for the sake of clarity?
...
// @FIXME: Looks like some words were lost in the sentence:
