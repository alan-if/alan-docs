...
// @NOTE: It's not easy to decide when the SET nouns should be formated as inline code
//        or bold, or even normal text, in this section. Unlike other Alan terms, it's
//        not always clear if the noun is being discussed as a keyword, as the Set type,
//        or if it's being used in its general English meaning. My guess is that it
//        actually never refers to the Set keyword in the paragraphs below!
