...
// @TODO: Repharese from "The *expression* part...". The part explaining the BNF
//        rules could be made more readable and clearer.
...
// @FIXME: The following note was unclear, but even after adjusting it it seems
...
// @FIXME: First point: "BUT examples include an event scheduled at a particular
//         location, in WHICH case" -- which examples is it referring to?
...
// @NOTE: The following paragraph could be made clearer and more readable:
...
// @FIXME: Rephrase "want to know something about or which (???) THEY ARE. THEY ARE"
//         Not clear, especially the "ABOUT OR WHICH" part.
//        The consecutive "THEY ARE. THEY ARE" sounds bad...
