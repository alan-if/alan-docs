...
////
@FIXME: The special chars in the Table are not represented correctly in the PDF
        output: '⋮' and '🡳' are rendered as '#'.
        Possible solutions:
          (a) Conditionally define a custom attribute for sbustitution, depending
              on the current backend, to allow alternative characters to be used
              in the PDF.
          (b) Find alternative characters supported in all formats.
////
