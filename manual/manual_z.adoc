...
The DocBook + asciidoctor-fopub backend used to be really prickly about Glossary
entries -- what looked fine in HTML could be rendered very ugly in PDF, if not
broken outright. That backend was retired in August 2026 and the PDF is now
built by asciidoctor-pdf, which does not share the quirk.

Still worth checking the PDF after changes here, but no longer a minefield.
