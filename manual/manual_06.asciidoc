...
// @FIXME: The part "or at least is not only a tool in a puzzle" is not clear,
//         and needs repharsing too.
...
// @NOTE: Is it truely so? Can't the '-c' and '-l' switches be used unless the
...
// @NOTE: Here "Acode" is mentioned, but the term wasn't explained:
...
// @NOTE: For the following transcript session I've dropped the "gametranscript"
...
// @FIXME: This debug transcript seems rather old, and different from what you
