...
// .About This Document
_The Alan Manual_ has been ported to AsciiDoc by link:https://github.com/tajmone[Tristano Ajmone^,title="Visit Tristano Ajmone's profile on GitHub"].
This makes it easy to publish it in HTML, PDF and other formats.
It also features contents updates and many improvements, like syntax highlighting of Alan code examples. +
