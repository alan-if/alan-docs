...
System_Boundary(alan, "Alan IF Language System"){
 Container(compiler, "Alan Compiler", "Compiles Alan source to intermediate Acode stored in an Alan game file")
 Container(game_file, "Alan game file")
 Container(interpreter, "Alan Interpreter", "Reads the Alan game file, and interprets player commands and appropriate instructions")
}
Rel(compiler, game_file, "generates")
Rel(interpreter, game_file, "reads")
Rel(interpreter, player, "displays effekts")
